...
function mostrarTarefas() {
    ...
    minhaListaDeItens.forEach((item, posicao) => {
        ...
        <button class="concluir" id="concluir-${posicao}">
        ...
        <p>${item.tarefa}</p>
        <button class="remover" id="remover-${posicao}"> 
    ...
    minhaListaDeItens.forEach((item, posicao) => {
        let concluir = document.getElementById(`concluir-${posicao}`);
        concluir.addEventListener("click", () => concluirTarefa(posicao));
        let remover = document.getElementById(`remover-${posicao}`);
        remover.addEventListener("click", () => deletarItem(posicao));
    });
